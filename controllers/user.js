...
/* Método para poder buscar usuarios, con la paginación de Mongo DB */
...
export const listUsers= async (req, res) =>{
  try {
    ...
    // en el caso que NO hya usuarios
    ...
    return res.status(200).json({
      ...
      message: "PRUEBA LISTA DE USUARIOS"
    });
